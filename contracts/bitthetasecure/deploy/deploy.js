const BitThetaSecure = artifacts.require("BitThetaSecure");
const Token = artifacts.require("Token");
const Storage = artifacts.require("Storage");
const Messaging = artifacts.require("Messaging");
const BitTorrentIntegration = artifacts.require("BitTorrentIntegration");
const ThetaIntegration = artifacts.require("ThetaIntegration");
